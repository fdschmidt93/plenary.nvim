local TransientBuilder = require "plenary.transient.builder"
local Buffer = require "plenary.oop.buffer"
local common = require "neogit.buffers.common"
local Elements = require "plenary.transient.elements"
local logger = require "neogit.logger"
local util = require "neogit.lib.util"

local col = Elements.col
local row = Elements.row
local text = Elements.text
local Component = Elements.Component
local map = util.map
...
function M.builder()
  return TransientBuilder.new(M.new)
end
